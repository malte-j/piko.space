/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 730191bd5816ea50c9ab4c527abed09e)
// Runtime types generated with workerd@1.20260911.1 2026-09-12 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ASSETS: Fetcher;
	FIREBASE_PROJECT_ID: "piko-363817";
	MIGRATION_ENABLED: "false";
	DOCUMENTS: DurableObjectNamespace<import("./src/worker").DocumentDurableObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "DocumentDurableObject";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FIREBASE_PROJECT_ID" | "MIGRATION_ENABLED">> {}
}
